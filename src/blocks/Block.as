...
//	private static const blockLabelFormat:TextFormat = new TextFormat('LucidaBoldEmbedded', 10, 0xFFFFFF, true);
	...
	public static function setFonts(labelSize:int, argSize:int, boldFlag:Boolean, vOffset:int):void {
		...
		blockLabelFormat = new TextFormat(font, 12, 0xFFFFFF, false);//labelsize设置为12,且非粗体字_wh_wh
		argTextFormat = new TextFormat(font, 12, 0x505050, false);//argsize设置为12，且非粗体字_wh
	...
	public function removeBlock(b:Block):void {
		...
		/*SCRATCH::allow3d _wh*/ { Scratch.app.runtime.checkForGraphicEffects(); }
	}
	...
	public function deleteStack():Boolean {
		...
		/*SCRATCH::allow3d _wh*/ { app.runtime.checkForGraphicEffects(); }
		app.updatePalette();
		return true;
	}
