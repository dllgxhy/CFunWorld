...
public class Specs {
	...
	public static const categories:Array = [
	 // id   category name	color
		...
		[13, "Arduino Blocks",	cfunblocksColor],//ID号设为13，及颜色_wh
		[14, "Arduino Robot",	cfunblocksColor],//ID号设为13，及颜色_wh
...
//		["set laser head %n as %m.highlow",		" ", 13, "setdigital:",	2,	1],//激光头_wh
		...
		//二级积木模块添加：机器人_wh
		["————CK Board————",	"+",	14],//细分类别说明_wh
		["sound",	"r", 14, "readcksound"],//测控板模拟量_wh
		["slide",	"r", 14, "readckslide"],//测控板模拟量_wh
		["light",	"r", 14, "readcklight"],//测控板模拟量_wh
		["red key",	"b", 14, "readckkey1"],//测控板数字量_wh
		["green key",	"b", 14, "readckkey2"],//测控板数字量_wh
		["joystick X",	"r", 14, "readckjoyx"],//测控板模拟量_wh
		["joystick Y",	"r", 14, "readckjoyy"],//测控板模拟量_wh
		["set LED as %m.onoff",			" ", 14, "setckled:",	'on'],//led灯_wh
		
		["-"],//间隔_wh
		["————Robot Car————",	"+",	14],//细分类别说明_wh
		["read track sensor",				"r", 	14, "readtrack:"],//循迹传感器_wh
		["read avoid obstacle sensor",	"r", 	14, "readavoid:"],//避障传感器_wh
		//["read ultrasonic sensor",		"r", 	14, "readultrs:"],//超声波传感器_wh
		["read power sensor",				"r", 	14, "readpower:"],//电量传感器_wh
		["-"],//间隔_wh
		["set gray threshold as %n",		" ", 14, "setgray:",	600],//灰度阀值_wh
		["set forward speed as %n",		" ", 14, "setforward:",	120],//向前_wh
		["set back speed as %n",			" ", 14, "setback:",		120],//后退_wh
		["set left speed as %n",			" ", 14, "setleft:",		120],//左转_wh
		["set right speed as %n",		" ", 14, "setright:",		120],//右转_wh
		//["set buzzer(LED) as %m.onoff",		" ", 14, "setbuzzer:",	'on'],//蜂鸣器_wh
		["set arm %m.arm angle as %n",	" ", 14, "setarm:",	'updown',	20],//舵机角度_wh
	];
