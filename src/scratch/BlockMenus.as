...
//		if (menuName == 'ckasensor') menuHandler.cka(evt);//增加ck板模拟管脚_wh
//		if (menuName == 'ckdsensor') menuHandler.ckd(evt);//增加ck板数字管脚_wh
	}
...
//	//增加cka_wh
//	private function cka(evt:MouseEvent):void {
//		var m:Menu = new Menu(setBlockArg, 'ckasensor');
//		m.addItem('sound', 'sound');
//		m.addItem('slide', 'slide');
//		m.addItem('light', 'light');
//		showMenu(m);
//	}
//	
//	//增加ckd_wh
//	private function ckd(evt:MouseEvent):void {
//		var m:Menu = new Menu(setBlockArg, 'ckdsensor');
//		m.addItem('red key', 'red key');
//		m.addItem('green key', 'green key');
//		showMenu(m);
//	}
